...
def trainer():
	...
	import alexccnnmodel as al
	pred = al.alex_ccnn2(X, keep_prob)
	...
	with tf.Session() as sess:
		...
		saver.restore(sess, "/home/jess/Disk1/ilsvrc12/tf_alex_pre_ccnn_model_iter65001.ckpt-65001")
		step = 67502
		while step * batch_size < training_iters:
			...
			if (step % 2500==1) & (step>2500):
				save_path = saver.save(sess, "/home/jess/Disk1/ilsvrc12/tf_alex_ccnn_model_iter" + str(step) + ".ckpt", global_step=step)
		...
		save_path = saver.save(sess, "/home/jess/Disk1/ilsvrc12/tf_alex_ccnn_model.ckpt", global_step=step)
